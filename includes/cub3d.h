...
/*   Updated: 2025/01/28 19:09:32 by ivromero         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* read_map.c */
void					validate_map_first_line(char **line,
							t_map_data *map_data);
void					validate_map_lines(int fd, char **line,
							t_map_data *map_dat);
void					validate_map_last_line(char *line,
							t_map_data *map_data);
...
void					my_mlx_pixel_put(t_data *dsp_dt, int x, int y,
							int color);
